"""racingpro_19285 URL Configuration
...
admin.site.site_header = "RacingPro"
admin.site.site_title = "RacingPro Admin Portal"
admin.site.index_title = "RacingPro Admin"

# swagger
api_info = openapi.Info(
    title="RacingPro API",
    default_version="v1",
    description="API documentation for RacingPro App",
)
